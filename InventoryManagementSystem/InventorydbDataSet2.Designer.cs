...
namespace InventoryManagementSystem {
    ...
    public partial class InventorydbDataSet2 : global::System.Data.DataSet {
        ...
        public partial class CategoryTblDataTable : global::System.Data.TypedTableBase<CategoryTblRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CategoryTblRow AddCategoryTblRow(int Id, string CatName) {
...
namespace InventoryManagementSystem.InventorydbDataSet2TableAdapters {
    ...
    public partial class CategoryTblTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[CategoryTbl] WHERE (([Id] = @Original_Id) AND ([CatName] = @Or" +
                "iginal_CatName))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[CategoryTbl] ([Id], [CatName]) VALUES (@Id, @CatName);\r\nSELECT" +
                " Id, CatName FROM CategoryTbl WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[CategoryTbl] SET [Id] = @Id, [CatName] = @CatName WHERE (([Id] = @O" +
                "riginal_Id) AND ([CatName] = @Original_CatName));\r\nSELECT Id, CatName FROM Categ" +
                "oryTbl WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, CatName FROM dbo.CategoryTbl";
        ...
        public virtual int Fill(InventorydbDataSet2.CategoryTblDataTable dataTable) {
        ...
        public virtual InventorydbDataSet2.CategoryTblDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            InventorydbDataSet2.CategoryTblDataTable dataTable = new InventorydbDataSet2.CategoryTblDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(InventorydbDataSet2.CategoryTblDataTable dataTable) {
        ...
        public virtual int Insert(int Id, string CatName) {
        ...
        public virtual int Update(int Id, string CatName, int Original_Id, string Original_CatName) {
        ...
        public virtual int Update(string CatName, int Original_Id, string Original_CatName) {
            return this.Update(Original_Id, CatName, Original_Id, Original_CatName);
        }
    }
